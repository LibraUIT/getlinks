class ApplicationController < ActionController::Base
  ...
  def prepare_meta_tags(options={})
    ...
    description = "Get link mp3 lossless, get link JAVHD, download JAVHD videos, get link javhd, free javhd videos, get link Instagram, download facebook video, get link Fshare. Watch hot girl video & photos."
    ...
    defaults = {
      ...
      keywords:    "get link, free javhd, download javhd video, download facebook video, download video instagram, get link fshare, get link mp3 lossless, download video youtube, girl xinh, hot girl, photos, xem anh girl xinh",
      twitter: {
        site_name: site_name,
        site: '@linknhanh.info',
        card: 'summary',
